const Footer = () => {
  return (
    <div className="flex flex-col gap-[25px] pt-16 pb-[75px]">
      <div className="flex gap-5 ">
        <div className="flex gap-6 flex-col">
          <div className="w-[280px] flex flex-col gap-3">
            <p className="font-semibold text-lg text-textColor2">About</p>
          ...
          <div className="flex flex-col gap-1">
            <p className="text-textColor2">
              Email :{" "}
              <span className="text-textColor">info@jstemplate.net</span>
            </p>
            <p className="text-textColor2">
              Phone : <span className="text-textColor">880 123 456 789</span>
            </p>
          </div>
        </div>
      ...
      <div className="flex border-t border-borderColor3 py-[20.5px] justify-between items-center">
